package ru.tinkoff.edu.java.bot.model.core;

import com.pengrad.telegrambot.model.Update;
import com.pengrad.telegrambot.model.request.ParseMode;
import com.pengrad.telegrambot.request.SendMessage;

import ru.tinkoff.edu.java.bot.model.manage.Command;
import ru.tinkoff.edu.java.bot.model.manage.Track;
import ru.tinkoff.edu.java.bot.model.manage.Untrack;
...
public class Updater {
    ...
    private SendMessage invalidCommandMessage(Update update) {
        return new SendMessage(update.message().chat().id(), "<b>Неизвестная команда!</b>\n " +
                "Чтобы получить список доступных команд, используйте команду /help").parseMode(ParseMode.HTML);
    }
}
